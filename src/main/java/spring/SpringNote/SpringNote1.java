...
public class SpringNote1 {
    ...
    Spring Expression：是Spring表达式语言。Spring3.0创建了一种新的方式用于配置对象的注入，他便是SPEL即Spring Expression Language。有别于传统的Spring静态配置，他支持在运行时操作和查询对象，其语法类似统一的EL语言。但是SPEL提供了额外的功能，具体功能会在后面的学习中给出。
